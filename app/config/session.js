...
module.exports.session = {
  ...
  *                                                                          *
  ***************************************************************************/
  secret: 'a4eaec24cc57f92dcf7f57efe84f6cda',


  /***************************************************************************
  *                                                                          *
  * Set the session cookie expire time The maxAge is set by milliseconds,    *
  * the example below is for 1 hours                                        *
  *                                                                          *
  ***************************************************************************/
  ...
  ***************************************************************************/
   ...
   // host: 'localhost',
   // port: 27017,
   // db: 'Passport_Questionare',
   url: 'mongodb://@127.0.0.1:27017/Passport_Questionare', // user, password and port optional
